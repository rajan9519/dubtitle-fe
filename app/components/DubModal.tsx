    ...
    <>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Dub your content</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  {file ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <p className="text-gray-900 font-medium mb-1">Click or drag to upload here</p>
                        <p className="text-gray-600 text-sm">Audio or video file, up to 100MB or 5 minutes</p>
                      </div>
                      <button
                        type="button"
          ...
          <button
            ...
            className="w-full py-4 bg-black text-white font-semibold rounded-lg hover:bg-gray-800 hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {uploading ? (
      ...
      {showAlert && (
        <div className="fixed top-4 right-4 z-[60] animate-in slide-in-from-top-2 duration-300">
          <div className={`px-6 py-4 rounded-lg shadow-lg border max-w-sm ${
            alertType === 'success' 
