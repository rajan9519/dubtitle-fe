      ...
      <div className="container mx-auto px-6">
        ...
        <div className="mt-12 pt-12 border-t border-gray-800 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            ...
            />
            <button className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300">
              Subscribe
            </button>
          </div>
