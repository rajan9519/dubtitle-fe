...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `Our plans are already designed to provide great value for bulk dubbing with generous minute allowances. The Professional plan gives you 90 minutes of dubbing for just ${formatPrice(convertPrice(pricingPlans[2].price, currency), currency)}. For enterprise customers with high-volume needs, <a href="/contact" class="text-blue-600 hover:text-blue-700 underline">contact our sales team</a> for custom pricing and volume discounts.`
    }
  ];
