        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-purple-100">
              You&apos;re about to unlock the power of AI dubbing
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-white mb-2">{starterPlan.name} Plan</h2>
              <div className="text-5xl font-bold text-yellow-300 mb-2">
                {starterPlan.originalPrice && (
              ...
              <p className="text-purple-100">{starterPlan.duration}</p>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-bold text-xl rounded-xl hover:shadow-2xl hover:shadow-yellow-500/25 transition-all duration-300 transform hover:scale-105"
            >
              Proceed to Payment
            </button>
